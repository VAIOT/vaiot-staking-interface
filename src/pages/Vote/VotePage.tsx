...
import { AVERAGE_BLOCK_TIME_IN_SECS, COMMON_CONTRACT_NAMES, VAI, ZERO_ADDRESS } from '../../constants'
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="10px" style={{ width: '100%' }}>
          ...
          {proposalData && proposalData.status === 'active' && !showVotingButtons && (
            <GreyCard>
              <TYPE.black>
                Only VAI votes that were self delegated or delegated to another address before block{' '}
