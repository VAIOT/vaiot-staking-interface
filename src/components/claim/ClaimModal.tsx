      ...
      {!attempting && !claimConfirmed && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim VAI</TYPE.white>
            ...
            <CardSection gap="sm">
              {userClaimData?.flags?.isSOCKS && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{SOCKS_AMOUNT} VAI</TYPE.subHeader>
                </RowBetween>
              )}
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{USER_AMOUNT} VAI</TYPE.subHeader>
                </RowBetween>
              )}
            </CardSection>
          </ModalUpper>
          ...
          <AutoColumn gap="100px" justify={'center'}>
            ...
            {attempting && claimSubmitted && !claimConfirmed && chainId && claimTxn?.hash && (
              <ExternalLink href={getEtherscanLink(chainId, claimTxn?.hash, 'transaction')} style={{ zIndex: 99 }}>
                View transaction on {getEtherscanName(chainId)}
              </ExternalLink>
            )}
          </AutoColumn>
